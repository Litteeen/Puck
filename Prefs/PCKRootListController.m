...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.enableSwitch.onTintColor = [UIColor colorWithRed: 0.68 green: 0.87 blue: 0.85 alpha: 1.00];
        ...
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/PuckPrefs.bundle/icon@2x.png"];
...
- (void)viewDidLoad {
    ...
    self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/PuckPrefs.bundle/Banner.png"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.navigationController.navigationController.navigationBar.barTintColor = [UIColor colorWithRed: 0.86 green: 0.86 blue: 0.84 alpha: 1.00];
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/Library/MobileSubstrate/DynamicLibraries/Puck.disabled"]) return;
    [[self enableSwitch] setEnabled:NO];

    UIAlertController* alertController = [UIAlertController alertControllerWithTitle:@"Puck"
	message:@"Puck Preferences disabled due to Puck being disabled with iCleaner Pro"
...
- (void)toggleState {
    ...
    NSString* path = [NSString stringWithFormat:@"/var/mobile/Library/Preferences/love.litten.puckpreferences.plist"];
    NSMutableDictionary* dictionary = [NSMutableDictionary dictionaryWithContentsOfFile:path];
    NSSet* allKeys = [NSSet setWithArray:[dictionary allKeys]];
    HBPreferences *preferences = [[HBPreferences alloc] initWithIdentifier: @"love.litten.puckpreferences"];
    
    if (!([[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/love.litten.puckpreferences.plist"])) {
        enabled = YES;
...
- (void)resetPrompt {
    ...
    UIAlertController* resetAlert = [UIAlertController alertControllerWithTitle:@"Puck"
